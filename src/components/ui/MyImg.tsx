  ...
  return (
    <>
      <motion.div
        ...
        <div className="relative rounded-xl h-[480px] w-[380px] overflow-hidden">
          <div className="content-none absolute bg-gradient-to-r from-red-950 to-purple-950 animate-spin ease-linear duration-500 w-[180px] h-[170%] -top-32 right-[30%] shadow"></div>
